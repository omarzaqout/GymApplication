...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/logogym.png"))); // NOI18N
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        ...
        try{
            con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","c##project","654321");
            ...
            while(rs.next()){
            if("Admin".equals(rs.getString("IS_MGR"))){
                setVisible(false);
                scmain admin=new scmain();
                admin.setVisible(true);
            }
             else if("Coach".equals(rs.getString("IS_MGR"))){
           /* ps=con.prepareStatement("Select * from users Where USERNAME=? And PASSWORD=? AND IS_MGR=0");
            ps.setString(1, username);
            ps.setString(2, password);*/
            setVisible(false);
            sccoach coach=new sccoach();
            coach.setVisible(true);
            }
            else{
                JOptionPane.showMessageDialog(this,  "user name or password are invalid");
            }
            }
            }
        catch(Exception e){
                  JOptionPane.showMessageDialog(this,  "Caatch");
            }
        /*
